...
const StoreNewPasswordScreen = () => {
    ...
    const savePassword = async () => {
      try {
          ...
          // Add the new password info to the existing passwords array
          const updatedPasswords = [...passwordsArray, newPassword];
  
          // Update AsyncStorage with the updated passwords array
          await AsyncStorage.setItem("passwords", JSON.stringify(updatedPasswords));
  
          // Navigate to DisplayPasswordInfoScreen with updated passwords array
